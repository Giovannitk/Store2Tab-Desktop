...
{
    public class NumerazioneViewModel
    {
        ...
        public void SelezionaNumerazione(string codice, string descrizione, string sigla,
                                        string documentoElettronico, string tipoDocumentoElettronico)
        {
            MessageBox.Show($"Selezionata numerazione: {codice} - {descrizione} ({sigla})");
        }
    }
}